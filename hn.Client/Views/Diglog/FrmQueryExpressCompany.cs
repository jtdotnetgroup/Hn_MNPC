...
namespace hn.Client
{
    public partial class FrmQueryExpressCompany : FrmBase
    {
        ...
        {
            var list = _service.GetExpressCompanyList(keyword).Where(w=>!w.mn_using.Equals(null)).OrderByDescending(o=>o.mn_using).ToList();
        ...
        private void FrmQueryExpressCompany_KeyDown(object sender, KeyEventArgs e)
        {
