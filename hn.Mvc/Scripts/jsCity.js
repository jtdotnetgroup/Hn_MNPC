...
var addressInit = function (_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea, search) {
    var cmbProvince = _cmbProvince; // document.getElementById(_cmbProvince);
    var cmbCity = _cmbCity; // document.getElementById(_cmbCity);
    var cmbArea = _cmbArea;// document.getElementById(_cmbArea);
