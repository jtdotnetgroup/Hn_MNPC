...
namespace hn.Mvc.Controllers
{
    public class portalController : BaseController
    {
        ...
        public ActionResult Edit()
        {
            ...
            //TB_portalModel model = TB_portalDal.Instance.Get(id);
        ...
        public string Add(FormCollection context)
        {
            try
            {
                ...
                //TB_portalDal.Instance.Insert(rpm.Entity);
        ...
        public string Edit(FormCollection context)
        {
            try
            {
                ...
                //TB_portalDal.Instance.Update(r);
        ...
        public string Delete(FormCollection context)
        {
            try
            {
                ...
                //int count = bll.GetCountByportal(rpm.FID);
                //if (count > 0)
                //{
                //    return JSONhelper.ToJson(new { errCode = -1, errMsg = "该品牌已经对应有电梯档案存在，无法删除！" });
                //}

                //TB_portalBll.Instance.Delete(rpm.FID);
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        //private RequestParamModel<TB_portalModel> GetRpm(FormCollection context)
        //{
        //    var json = context["json"];
        //    var rpm = new RequestParamModel<TB_portalModel>(context) { CurrentContext = context, Action = Request["action"] };
        //    if (!string.IsNullOrEmpty(json))
        //    {
        //        rpm = JSONhelper.ConvertToObject<RequestParamModel<TB_portalModel>>(json);
