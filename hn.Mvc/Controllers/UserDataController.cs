...
namespace hn.Mvc.Controllers
{
    public class UserDataController : BaseController
    {
        ...
        public ActionResult Edit()
        {
            ...
            //TB_UserDataModel model = TB_UserDataDal.Instance.Get(id);
        ...
        public string Add(FormCollection context)
        {
            try
            {
                ...
                //TB_UserDataDal.Instance.Insert(rpm.Entity);
        ...
        public string Edit(FormCollection context)
        {
            try
            {
                ...
                //TB_UserDataDal.Instance.Update(r);
        ...
        public string Delete(FormCollection context)
        {
            try
            {
                ...
                //int count = bll.GetCountByUserData(rpm.FID);
                //if (count > 0)
                //{
                //    return JSONhelper.ToJson(new { errCode = -1, errMsg = "该品牌已经对应有电梯档案存在，无法删除！" });
                //}

                //TB_UserDataBll.Instance.Delete(rpm.FID);
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        //private RequestParamModel<TB_UserDataModel> GetRpm(FormCollection context)
        //{
        //    var json = context["json"];
        //    var rpm = new RequestParamModel<TB_UserDataModel>(context) { CurrentContext = context, Action = Request["action"] };
        //    if (!string.IsNullOrEmpty(json))
        //    {
        //        rpm = JSONhelper.ConvertToObject<RequestParamModel<TB_UserDataModel>>(json);
