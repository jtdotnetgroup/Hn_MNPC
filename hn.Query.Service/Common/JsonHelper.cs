...
namespace hn.Client.Service
{
    ...
    public class JsonHelper
    {
        ...
        public static string JsonToDataGrid(int totalcount, object data, string pager = "")
        {
            return ToJson(new { total = totalcount, rows = data, pager = pager });
        }
        ...
        {
            return ConvertToObject<Dictionary<string, object>>(jsonText);
        }
    }
}
