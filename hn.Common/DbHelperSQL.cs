...
namespace hn.DBUtility
{
    ...
    { 
        ...
        //定义连接字符串。
        protected static string ConnectionString =SqlEasy.connString;// DecryptDBStr(ConfigurationManager.AppSettings["SQLConnectionString"], "zhangweilong");
