...
public static class MyExtensions
{
    ...
    public static string ToDateTimeShortString(this DateTime date)
    {
    ...
    public static string GetOracleToDateString(this DateTime date)
    {
        return string.Format(" TO_DATE('{0}','yyyy-MM-dd HH:mm:ss:fff') ", date.ToDateTimeString());
    }

    public static string GetOracleToDateShortString(this DateTime date)
    {
        return string.Format(" TO_DATE('{0}','yyyy-MM-dd') ", date.ToDateTimeShortString());
    }
    ...
    /// <param name="value"></param>
    /// <returns></returns>
    public static bool IsTrue(this decimal value)
    {
        return Convert.ToBoolean(value);
    }


    public static string[] SplitWithoutSpace(this string value, char splitChar = ',')
    {
    ...
    public static string[] SplitWithoutSpace(this string value, string splitString)
    {
        if (value.IsNullOrEmpty())
        {
            return new string[0];
    ...
    public static bool ToBool(this object obj)
    {
        ...
        if (obj.ToStr().ToLower() == "true" || obj.ToStr().ToLower() == "1")
        {
            return true;
        }
