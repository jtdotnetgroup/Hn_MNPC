...
namespace hn.Common.Data.SqlServer
{
    public static class SqlEasy
    {
        ...
        public static string connString
        {
            get
            {
                try
                {
                    ...
                    //string connStr = "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=10.0.124.6)(PORT=1521)) (CONNECT_DATA=(SERVICE_NAME=purchasedb)));User ID=purchase;Password=purchase;Unicode=True";
                    return connStr;

                }
                catch
                {
                    return "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=10.0.124.6)(PORT=1521)) (CONNECT_DATA=(SERVICE_NAME=purchasedb)));User ID=purchase;Password=purchase;Unicode=True";
                }
            }
        }
        ...
        public static DataTable ExecuteDataTable(string sql, params OracleParameter[] para)
        {
            return SqlHelper.ExecuteDataset(connString, CommandType.Text, sql, para).Tables[0];
        }

        public static DataTable ExecuteDataTable(string connectionString, string sql, params OracleParameter[] para)
        {
        ...
        public static int ExecuteNonQuery(string sql, params OracleParameter[] para)
        {
            return SqlHelper.ExecuteNonQuery(connString, CommandType.Text, sql, para);
        }

        public static int ExecuteNonQuery(string connectionString, string sql, params OracleParameter[] para)
        {
        ...
        public static object ExecuteScalar(string sql, params OracleParameter[] para)
        {
            return SqlHelper.ExecuteScalar(connString, CommandType.Text, sql, para);
        }

        public static object ExecuteScalar(string connectionString, string sql, params OracleParameter[] para)
        {
        ...
        public static OracleDataReader ExecuteDataReader(string sql, params OracleParameter[] para)
        {
        ...
        public static OracleDataReader ExecuteDataReader(string connectionString, string sql)
        {
            return SqlHelper.ExecuteReader(connectionString, CommandType.Text, sql);
        }

        public static OracleDataReader ExecuteDataReader(string connectionString, string sql, params OracleParameter[] para)
        {
        ...
        public static DataTable ExecuteProcedure(string procedureName, params OracleParameter[] para)
        {
            return SqlHelper.ExecuteDataset(connString, CommandType.StoredProcedure, procedureName, para).Tables[0];
        }

        public static string ExecuteString(string procedureName, int index, params OracleParameter[] para)
        {
            return SqlHelper.ExecuteString(connString, CommandType.StoredProcedure, procedureName, index, para);
        }

        public static string ExecuteString(string procedureName, string paramenterName, params OracleParameter[] para)
        {
            return SqlHelper.ExecuteString(connString, CommandType.StoredProcedure, procedureName, paramenterName, para);
        }

        public static DataTable ExecuteProcedure(string connectionString, string procedureName, params OracleParameter[] para)
        {
            return SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, procedureName, para).Tables[0];
        }

        public static string ExecuteString(string connectionString, string procedureName, int index, params OracleParameter[] para)
        {
            return SqlHelper.ExecuteString(connectionString, CommandType.StoredProcedure, procedureName, index, para);
        }

        public static string ExecuteString(string connectionString, string procedureName, string paramenterName, params OracleParameter[] para)
        {
        ...
        public static int ExecuteTran(string commandText, params OracleParameter[] para)
        {
        ...
        public static int ExecuteTran(string connectionString, string commandText, params OracleParameter[] para)
        {
        ...
        public static DataRow ExecuteDataRow(string sql, params OracleParameter[] para)
        {
            DataRow row = null;
        ...
        public static DataRow ExecuteDataRow(string connectionString, string sql, params OracleParameter[] para)
        {
            DataRow row = null;
        ...
        public static string ExecuteObject(string sql, params OracleParameter[] para)
        {
        ...
        public static string ExecuteObject(string connectionString, string sql, params OracleParameter[] para)
        {
        ...
        public static DataTable GetDataByPager2005(string SelectList, string tablename, string where, string OrderExpression, int pageindex, int pagesize)
        {
            ...
            para[0] = new OracleParameter("SelectList", SelectList);
            para[1] = new OracleParameter("TableSource", tablename);
            para[2] = new OracleParameter("SearchCondition", where);
            para[3] = new OracleParameter("OrderExpression", OrderExpression);
            para[4] = new OracleParameter("pageindex", pageindex);
            para[5] = new OracleParameter("pagesize", pagesize);
