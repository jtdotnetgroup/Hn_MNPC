...
namespace hn.Common
{
    ...
    public class JSONhelper
    {
        ...
        /// <param name="rows">每页记录的JSON格式</param>
        /// <returns></returns>
        public static string FormatJSONForEasyuiDataGridFooter(int recordcount, object rowsList,object footer)
        {
            return ToJson(new { total = recordcount, rows = rowsList ,footer= footer });
        }
