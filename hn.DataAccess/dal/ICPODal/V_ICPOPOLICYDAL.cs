...
{
    public class V_ICPOPOLICYDAL : BaseRepository<V_ICPOPOLICYMODEL>
    {
        public static V_ICPOPOLICYDAL Instance
        {
            get { return SingletonProvider<V_ICPOPOLICYDAL>.Instance; }
        }
