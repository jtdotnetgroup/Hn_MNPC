...
{
    public class ICPO_BOLentryDAL : BaseRepository<ICPO_BOLentryModel>
    {
        public static ICPO_BOLentryDAL Instance
        {
            get { return SingletonProvider<ICPO_BOLentryDAL>.Instance; }
        }
