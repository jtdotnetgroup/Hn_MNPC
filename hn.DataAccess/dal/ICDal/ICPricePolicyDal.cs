...
{
    public class ICPRICEPOLICYDAL : BaseRepository<ICPRICEPOLICYMODEL>
    {
        public static ICPRICEPOLICYDAL Instance
        {
            get { return SingletonProvider<ICPRICEPOLICYDAL>.Instance; }
        }

        //public string GetJson(int pageindex, int pagesize, string filterJson, string sort = "FID",
        //                      string order = "asc")
        //{
        //    return base.JsonDataForEasyUIdataGrid(TableConvention.Resolve(typeof(ICPRICEPOLICYMODEL)), pageindex, pagesize, filterJson,
        //                                          sort, order);
        //}
